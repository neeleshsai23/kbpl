...
@Component({
  selector: 'app-mrc-add-project-dialog',
  templateUrl: './mrc-add-project-dialog.component.html',
  styleUrls: ['./mrc-add-project-dialog.component.scss']
})
export class MrcAddProjectDialogComponent implements OnInit {
