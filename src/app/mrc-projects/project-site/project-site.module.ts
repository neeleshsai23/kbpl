...
export const routes = [
  { path: '', redirectTo:"dlr", pathMatch: 'full'},
  { path: 'dlr', component:DlrComponent,loadChildren:'./dlr/dlr.module#DLRModule' ,data: { breadcrumb: 'Projects' } },
  { path: 'dpr', component:DprComponent, data: { breadcrumb: 'Projects' } },
  { path: 'issues', component:IssuesComponent, data: { breadcrumb: 'Projects' } },
  { path: 'photos', component:PhotosComponent, data: { breadcrumb: 'Projects' } },
  { path: 'targets', component:TargetsComponent, data: { breadcrumb: 'Projects' } }
];
