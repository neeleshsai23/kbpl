...
export const routes = [
  ...
  { path: 'correspondence', component:CorrespondenceComponent, data: { breadcrumb: 'Projects' } },
  { path: 'drawing-register', component:DrawingRegisterComponent, data: { breadcrumb: 'Projects' } },
  { path: 'quotations', component:QuotationsComponent, data: { breadcrumb: 'Projects' } },
  { path: 'tender', component:TenderComponent, data: { breadcrumb: 'Projects' } },
  { path: 'work-orders', component:WorkOrdersComponent, data: { breadcrumb: 'Projects' } },
];
