...
export const routes = [
  ...
  { path: 'defect-liability', component:DefectLiabilityComponent, data: { breadcrumb: 'Projects' } },
  { path: 'final-bill', component:FinalBillComponent, data: { breadcrumb: 'Projects' } },
  { path: 'guarentees', component:GuarenteesComponent, data: { breadcrumb: 'Projects' } },
  { path: 'inventory-shifting', component:InventoryShiftingComponent, data: { breadcrumb: 'Projects' } },
  { path: 'reports', component:ReportsComponent, data: { breadcrumb: 'Projects' } },
  { path: 'returns', component:ReturnsComponent, data: { breadcrumb: 'Projects' } },
];
