...
export class FatMasterComponent implements OnInit {
  ...
  tableList = [
    {fat:"Electrical Control Cabinet (TAG22T3-100B)",status:true},
    {fat:"Standard Work Procedures",status:true},
    {fat:"Certificates of Compliance",status:true},
    {fat:"Equipment Data Sheets",status:true},
