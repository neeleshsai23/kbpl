...
@Component({
  selector: 'app-projects-mapview',
  templateUrl: './projects-mapview.component.html',
  styleUrls: ['./projects-mapview.component.scss']
})
export class ProjectsMapviewComponent implements OnInit {
