...
export class ProjectsKanbanviewComponent implements OnInit {
  ...
  localData: any[] = [
    ...
    { id:"kanban_table_3", collapsed:false,style:{'background-color':'rgb(189, 215, 238)'}, stage:'Initiated', header: 'Initiated (1)', data : [{ id: 'kanban_item_1166', name: 'TRPR', info: 'Updates: 6', colorCode: 'Green',percentage: 'Completion: 75%', campaign: 'Sandbank | Dwayne',projectcode:"Sai Constructions", actions: 'Schedule: 9/10',budget: 'Budget: $ 652/750',tasks:'Schedule: 78/100',duedate:'Completion Date: 20-04-21', hex: '#FFFFFF',clientName:"Tharun",stage:"Stage: Electrical",cost:"Cost:12 cr/14.09 cr",updateddate:'last updated : 1 day ago',colorcode2:"rgb(122 ,173, 22)",colorcode1:"rgb(165, 42, 42)"}]},
    { id:"kanban_table_4", collapsed:false,style:{'background-color':'rgb(189, 215, 238)'}, stage:'Progress', header: 'Progress (1)', data : [{ id: 'kanban_item_1164', name: 'Survey',  info: 'Updates: 2', colorCode: 'Green',percentage: 'Completion: 88%', campaign: 'Valleymede | Dave',projectcode:"Siva Infra" , actions: 'Schedule: 7/10',budget: 'Budget: $ 425/650',tasks:'Schedule: 85/100',duedate:'Completion Date: 18-11-21', hex: '#FFFFFF',clientName:"Kalyan",stage:"Stage: Fire Fighting",cost:"Cost:10 cr/11 cr",updateddate:'last updated : 1 month ago',colorcode1:"rgb(122 ,173, 22)",colorcode2:"rgb(165, 42, 42)"}]},
